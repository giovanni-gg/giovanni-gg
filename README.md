...
- **de-dbt** — Company-wide analytics engineering. A **dbt + BigQuery** data warehouse (530+ models) on a 4-layer medallion architecture, unifying **30+ data sources** — Shopify, Amazon (EU/NA/JP), marketplaces (Bol, Zalando, Allegro, Decathlon, Boozt…), ad platforms (Amazon/Google/Meta/Microsoft Ads), Klaviyo, GA4 and Business Central — into governed sales, advertising, inventory, finance and customer models that power BI across the business. *(390+ merged PRs authored, of 970+ in the repo.)*
